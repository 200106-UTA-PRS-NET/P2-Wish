...
using MovieBox.DataAccess.Repositories;
using MovieBox.Library;
using MovieBox.Library.Interfaces;

namespace MovieBox.WebAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<MovieBoxContext>(options =>
                options.UseSqlServer(Configuration.GetConnectionString("MovieBoxDB")));
